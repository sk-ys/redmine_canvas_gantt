module RedmineCanvasGantt
  class BaselineSnapshot
    attr_reader :snapshot_id, :project_id, :captured_at, :captured_by_id, :captured_by_name, :task_states

    def initialize(snapshot_id:, project_id:, captured_at:, captured_by_id:, captured_by_name:, task_states:)
